...
def actuator(model_dir: str, execute_type: str, model_type: str = "bert") -> NoReturn:
    """
    :param model_dir: 预训练模型目录
    :param execute_type: 执行类型
    :param model_type: 使用模型类型
    """
    pad_max_len = 40
    batch_size = 64
    seed = 1
    ...
    if execute_type == "preprocess":
        ...
        if model_type == "bert":
            ...
            bert = albert(config=bert_config, batch_size=batch_size, with_pool=True)
